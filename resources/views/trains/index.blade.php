...
<div class="container">
    <div class="row">
        ...
        <div class="card mb-3">
            ...
            <p>in partenza da {{$item ->Stazione_di_partenza}}, alle ore: {{$item ->Orario_di_partenza}} </p>
    ...
    @foreach ($trains as $train)
        <div class="col-6">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <h1>Il treno {{$train ->Azienda}} in partenza  da {{$train ->Stazione_di_partenza}} e in arrivo a {{$train ->Stazione_di_arrivo}} </h1>
